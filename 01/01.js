...
function fibonacciCalc(selectedNumber) {
    let firstValue = 0;
    let secondValue = 1;
    let currentValue = firstValue + secondValue; 

    do {
        firstValue = secondValue;
        secondValue = currentValue;
        currentValue = firstValue + secondValue;
    } while (currentValue < selectedNumber);

    isPartOf(selectedNumber, currentValue);
} 

function isPartOf(selectedNumber, currentValue) {
